...
def roc_auc_graph(y_test, y_predict):
    ...
    data = dict(false_positive_rate = false_positive_rate, true_positive_rate = true_positive_rate)
    ...
    plt.plot('False Positive Rate', 'True Positive Rate', data = ROC, marker = '', markersize = 8, color = 'navy', linewidth = 3)
